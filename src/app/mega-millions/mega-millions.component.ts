...
@Component({
  ...
  styleUrl: './mega-millions.component.scss'
})
export class MegaMillionsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.service.getMegaMillionsData().subscribe((data: any) => {
      console.log('Mega Millions data: ', this.service.getPrettyJson(data[0]));
